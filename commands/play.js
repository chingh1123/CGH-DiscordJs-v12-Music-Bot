...
module.exports = {
  ...
  run: async function(client, message, args) {
    ...
    const play = async (song) => {
      ...
      if (!song) {
        if (!online.afk) {
          sendError("Leaving the voice channel because I think there are no songs in the queue. If you like the bot stay 24/7 in voice channel run `gh-247`", message.channel)
