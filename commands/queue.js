...
function generateQueueEmbed(message, queue) {
  ...
  for (let i = 0; i < queue.length; i += 10) {
    ...
    const embed = new MessageEmbed()
      .setAuthor("🌿 Server Songs Queued", "https://c.tenor.com/HJvqN2i4Zs4AAAAj/milk-and-mocha-cute.gif")
      .setThumbnail(message.guild.iconURL())
      .setColor("BLUE")
      .setDescription(`${info}`)
      .addField("**__Now Playing:__**", `[${queue[0].title}](${queue[0].url})`, true)
      .addField("**__Text Channel:__**", serverQueue.textChannel)
      .addField("**__Voice Channel__**", serverQueue.voiceChannel, true)
      .setFooter("Currently Server Volume is： " + serverQueue.volume, guild.iconURL({ dynamic: true }))
